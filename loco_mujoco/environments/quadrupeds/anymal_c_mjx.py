...
class MjxAnymalC(AnymalC):
    ...
    def _modify_spec_for_mjx(self, spec: MjSpec):
        ...
        spec.add_pair(geomname1="floor", geomname2="LF")
        spec.add_pair(geomname1="floor", geomname2="LH")
        spec.add_pair(geomname1="floor", geomname2="RF")
        spec.add_pair(geomname1="floor", geomname2="RH")
